...
\subsection{実行環境・使用技術}
\begin{itemize}
  \item Python 3.10.8
\end{itemize}


\subsection{ローカル環境でBotが動作するようにする}
まずはローカル環境でBotが動作するようにしてみます。

\subsubsection{Botの作成・管理をする}
...
\subsubsection{Botが特定のワードに反応して、特定のメッセージを返答する機能をつける}
